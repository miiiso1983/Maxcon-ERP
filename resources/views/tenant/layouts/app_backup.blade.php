                    ...
                    <div class="btn-toolbar mb-2 mb-md-0">
                        ...
                        <div class="dropdown">
                            <button class="btn btn-outline-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown">
                                <i class="fas fa-user {{ marginEnd('1') }}"></i>
                                {{ auth()->user()->name ?? 'User' }}
                            </button>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="#"><i class="fas fa-user-cog {{ marginEnd('2') }}"></i>Profile</a></li>
                                <li><a class="dropdown-item" href="#"><i class="fas fa-cog {{ marginEnd('2') }}"></i>Settings</a></li>
